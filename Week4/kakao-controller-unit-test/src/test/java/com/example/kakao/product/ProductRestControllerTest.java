...
public class ProductRestControllerTest {
    ...
    public void findAll_test() throws Exception {
        ...
        result.andExpect(MockMvcResultMatchers.jsonPath("$.response[0].image").value("/images/10.jpg"));
        result.andExpect(MockMvcResultMatchers.jsonPath("$.response[0].price").value(8900));
    }

    @Test
    public void finaById_test() throws Exception {
        // given
        int id = 1;
    ...
    @Test
    public void finaById_fail_test() throws Exception {
        // given
        int id = 100;
