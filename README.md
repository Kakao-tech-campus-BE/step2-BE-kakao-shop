...
+ UserRestController, UserService, UserRestControllerTest를 제외한 컨트롤러, 서비스, 컨트롤러 테스트를 모두 새로 작성했습니다.

+ 현재 로그인 유저 정보를 이용할 수 없어 컨트롤러와 서비스 내의 로그인 유저의 정보가 필요한 로직의 경우 임의로 유저를 생성하거나 유저 정보 없이 동작하도록 작성했습니다. 참고 부탁드립니다. 
