...
1. API 주소를 설계해 README에 내용을 작성하시오.
    
    [https://w0nni.notion.site/2-59fc8d6d2c8d435b86fc7239fb1e9b12?pvs=4](https://w0nni.notion.site/2-59fc8d6d2c8d435b86fc7239fb1e9b12?pvs=4)
    
2. 가짜 데이터를 설계하여 응답하는 스프링 부트 컨트롤러를 작성하고 소스코드를 업로드하시오.
