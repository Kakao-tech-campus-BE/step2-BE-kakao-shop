...
public interface CartJPARepository extends JpaRepository<Cart, Integer> {
    ...
    @Modifying
    @Transactional
    @Query("UPDATE Cart c set c.quantity = c.quantity + :updateValue where c.option.id = :optionId")
    void update(@Param("optionId") int optionId, @Param("updateValue") Integer updateValue);
