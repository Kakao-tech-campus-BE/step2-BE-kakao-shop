...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.MOCK) //통합테스트 (SF - F - DS(Handler, Exhandler) - C - S - R -
public class CartRestControllerTest {
    @Autowired
    private MockMvc mvc;
    @Autowired
    private ObjectMapper om;
    @WithUserDetails(value = "ssarmango@nate.com") //UserDetailService의 loadByUsername을 실행함 -> DB에 있는지 조회한다. 있으면 통과 (인증 절차)
    @Test
