...
public class ProductService {
    ...
    public ProductResponse.FindByIdDTOv2 findByIdv2(int id) {
        // findbyproductidjoinproduct : option에서 product id
        // select 할건데 product를 조인한 것이 없으니까 만들자
    ...
    public List<ProductResponse.FindAllDTO> findAll(int page) {
        // 1. 페이지 객체 만들기 // page 받기
        Pageable pageable = PageRequest.of(page,9);

        // 2. DB 조회하기 // page 객체 넣기
        ...
        // stream으로 흩뿌리고 map으로 가공하고 collect로 수집하기
