...
//    private OptionService optionService;
    ...
    void beforeEach(){
        ...
        BDDMockito.given(fakeStore.getOrderList()).willReturn(
                Arrays.asList(order));
        BDDMockito.given(fakeStore.getItemList()).willReturn(cartList.stream().map(
                cart -> new Item(counter.getAndIncrement(), cart.getOption(), order, cart.getQuantity(),cart.getOption().getPrice() * cart.getQuantity())
