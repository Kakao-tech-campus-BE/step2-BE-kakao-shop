...
public class DummyEntity {
    ...
    protected List<Product> productList = productDummyList();
    protected List<Option> optionList = optionDummyList(productList);
    protected List<Cart> cartList = cartDummyList(optionList);
    protected List<Order> orderList = orderDummyList();
    protected List<Item> itemList = itemDummyList(cartList);

    protected User newUser(Integer id, String username){
    ...
    protected Cart newCart(Option option, Integer id, Integer quantity){
        return Cart.builder()
                .id(id)
                .user(newUser(1, "ssar"))
                .option(option)
    ...
    protected Item newItem(Cart cart, Integer id){
        return Item.builder()
                .id(id)
    ...
    protected List<Item> itemDummyList(List<Cart> cartList){
    ...
    protected List<Cart> cartDummyList(List<Option> optionList){
