...
class CartRestControllerTest extends DummyEntity {
    ...
    class Update {
        ...
        @DisplayName("장바구니 수정 실패: 인증되지 않은 사용자")
        @Test
        void update_unauthorizedUser_test() throws Exception {
    ...
    class addCartList {
        ...
        @DisplayName("장바구니 추가 실패: 인증되지 않은 사용자")
        @Test
        void addCartList_unauthorizedUser_test() throws Exception {
    ...
    class FindAll {
        ...
        @DisplayName("장바구니 조회 실패: 인증되지 않은 사용자")
        @Test
        void findAll_unauthorizedUser_test() throws Exception {
