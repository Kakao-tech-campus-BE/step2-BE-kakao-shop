...
public class DummyEntity {
    ...
    protected List<Cart> cartDummyList(User user, List<Option> optionList) {
        return Arrays.asList(
                newCart(user, optionList.get(0), 10),
                newCart(user, optionList.get(1), 20),
                newCart(user, optionList.get(2), 30),
                newCart(user, optionList.get(3), 40),
                newCart(user, optionList.get(4), 50),
                newCart(user, optionList.get(5), 60),
                newCart(user, optionList.get(6), 70),
                newCart(user, optionList.get(7), 80),
                newCart(user, optionList.get(8), 90)
        );
    }
