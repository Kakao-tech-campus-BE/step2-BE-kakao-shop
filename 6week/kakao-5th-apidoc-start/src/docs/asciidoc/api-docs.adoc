...
==== 응답 예시
include::{snippets}/order-rest-controller-test/save_test/response-body.adoc[]
...
==== 응답 예시
include::{snippets}/order-rest-controller-test/find-by-id_test/response-body.adoc[]
...
==== 요청 예시
include::{snippets}/user-rest-controller-test/email-check_test/http-request.adoc[]

==== 응답 예시
include::{snippets}/user-rest-controller-test/email-check_test/response-body.adoc[]