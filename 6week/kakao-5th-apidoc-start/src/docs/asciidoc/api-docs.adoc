...
=== 회원가입 실패 이름 예시
==== 요청 예시
include::{snippets}/{user}/join_name_fail_test/http-request.adoc[]
==== 응답 예시
include::{snippets}/{user}/join_name_fail_test/response-body.adoc[]
=== 회원가입 실패 이메일 예시
==== 요청 예시
...
==== 요청 예시
include::{snippets}/{order}/find-by-id_wrong_id_test/http-request.adoc[]
==== 응답 예시
include::{snippets}/{order}/find-by-id_wrong_id_test/response-body.adoc[]