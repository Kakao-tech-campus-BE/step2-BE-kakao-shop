...
class OrderRestControllerTest extends DummyEntity {
    ...
    void findById() throws Exception {
        ...
        result.andExpect(MockMvcResultMatchers.jsonPath("$.success").value("true"))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.response.products[0].items[0].quantity").value(10))
                .andExpect(MockMvcResultMatchers.jsonPath("$.response.products[0].items[0].price").value(100000));
