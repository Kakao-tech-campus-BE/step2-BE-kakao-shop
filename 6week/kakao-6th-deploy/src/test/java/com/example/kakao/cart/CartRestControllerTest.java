...
public class CartRestControllerTest extends MyRestDoc {
    ...
    @DisplayName("장바구니 담기 실패 테스트 - 중복 옵션")
    @WithUserDetails(value = "ssarmango@nate.com")
    @Test
    ...
    @DisplayName("장바구니 담기 실패 테스트 - 존재하지 않는 옵션")
    @WithUserDetails(value = "ssarmango@nate.com")
    @Test
    ...
    @DisplayName("주문하기 실패 테스트 - 주문할 상품 없음")
    @WithUserDetails(value = "ssarmango@nate.com")
    @Test
    ...
    @DisplayName("주문하기 실패 테스트 - 주문할 상품 중복")
    @WithUserDetails(value = "ssarmango@nate.com")
    @Test
    ...
    @DisplayName("주문하기 실패 테스트 - 장바구니에 없는 상품 주문")
    @WithUserDetails(value = "ssarmango@nate.com")
    @Test
    ...
    @DisplayName("주문하기 실패 테스트 - 총 주문 상품이 0개")
    @WithUserDetails(value = "ssarmango@nate.com")
    @Test
