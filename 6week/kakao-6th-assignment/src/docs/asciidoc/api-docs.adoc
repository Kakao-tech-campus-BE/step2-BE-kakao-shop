...
==== 요청 예시
include::{snippets}/{user}/join_duplicate-email_test/http-request.adoc[]

==== 응답 예시
include::{snippets}/{user}/join_duplicate-email_test/response-body.adoc[]

=== 회원가입 실패 예시 2
* 이메일 형식에 맞지 않은 경우

==== 요청 예시
include::{snippets}/{user}/join_not-email-form_test/http-request.adoc[]

==== 응답 예시
include::{snippets}/{user}/join_not-email-form_test/response-body.adoc[]
