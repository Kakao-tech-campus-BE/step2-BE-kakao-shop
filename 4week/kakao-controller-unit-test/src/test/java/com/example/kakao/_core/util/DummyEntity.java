...
public class DummyEntity {
    ...
    protected ProductOption newOption(Product product, String optionName, int price) {
    ...
    protected OrderItem newItem(Cart cart, Order order){
    ...
    protected List<ProductOption> optionDummyList(List<Product> productListPS) {
        return Arrays.asList(
