...
@Import({
        ...
        // UserRestController가 global을 들고있음
        // global이 errorlog를 들고있음
        // global은 실제로 test하고 싶음 errorlog는 구지 테스트하고 싶지 x
        // 그럼 가짜로 띄운다
})
@WebMvcTest(controllers = {UserRestController.class}) // controller
public class UserRestControllerTest {

    // 객체의 모든 메서드는 추상메서드로 구현됩니다. (가짜로 만들면)
    // 해당 객체는 SpringContext에 등록됩니다.
    @MockBean // userservice도 가짜로 띄우기 진짜는 controller, global
    private UserService userService;

    @MockBean // errorlog는 가짜로 띄우기
    ...
    public void join_test() throws Exception {
        ...
        // 터지는 이유는 security가 발동 안해서
        // resuletactions 사용하려면 securityconfig가 있어야함
    ...
    public void login_test() throws Exception {
        ...
        // login test할 때는 stub이 필요하다
        // 왜냐면 userservice는 껍데기 니까 null을 반환함
        // 그래서 stub을 가정법이라하는데 내부 구현을 해줌
