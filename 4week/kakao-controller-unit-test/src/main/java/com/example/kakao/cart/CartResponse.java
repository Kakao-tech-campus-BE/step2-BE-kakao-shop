...
public class CartResponse {
    ...
    public static class UpdateDTO{
        ...
        @Builder
        public UpdateDTO(List<CartDTO> carts, int totalPrice) {
            this.carts = carts;
    ...
    public static class FindAllDTO{
        ...
        public FindAllDTO(List<ProductDTO> products, int totalPrice) {
        ...
        public static class ProductDTO {
            ...
            public ProductDTO(int id, String productName, List<CartDTO> carts) {
                this.id = id;
            ...
            public static class CartDTO {
                ...
                public CartDTO(int id, OptionDTO option, int quantity, int price) {
                    this.id = id;
                    this.option = option;
                    this.quantity = quantity;
                    this.price = price;
