...
public class FakeStore {
    ...
    private List<com.example.kakao.order.item.Item> itemList = itemDummyList(cartList);
    ...
    private com.example.kakao.order.item.Item newItem(Cart cart, Integer id){
        return com.example.kakao.order.item.Item.builder()
                .id(id)
    ...
    private List<com.example.kakao.order.item.Item> itemDummyList(List<Cart> cartList){
