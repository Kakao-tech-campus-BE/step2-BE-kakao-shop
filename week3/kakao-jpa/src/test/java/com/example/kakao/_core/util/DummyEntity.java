...
public class DummyEntity {
    ...
    protected List<Cart> cartDummyList(List<Option> options, User user){
        return Arrays.asList(
    ...
    protected List<Item> itemDummyList(List<Cart> carts,List<Order> orders){
        return Arrays.asList(
                newItem(carts.get(0), orders.get(0)),
                newItem(carts.get(1), orders.get(0))
        );
    }
