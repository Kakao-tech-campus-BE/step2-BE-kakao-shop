...
import com.example.kakaoshop.product.response.ProductFindAllResDTO;
import com.example.kakaoshop.product.response.ProductFindByIdResDTO;
...
public ResponseEntity<?> findById(@PathVariable int id) {
    // 상품을 담을 DTO 생성
    ProductFindByIdResDTO responseDTO = null;
    ...
    if(id == 1){
        ...
        responseDTO = new ProductFindByIdResDTO(1, "기본에 슬라이딩 지퍼백 크리스마스/플라워에디션 에디션 외 주방용품 특가전", "", "/images/1.jpg", 1000, 5, optionDTOList);
        ...
        responseDTO = new ProductFindByIdResDTO(2, "[황금약단밤 골드]2022년산 햇밤 칼집밤700g외/군밤용/생율", "", "/images/2.jpg", 2000, 5, optionDTOList);
    }else {
