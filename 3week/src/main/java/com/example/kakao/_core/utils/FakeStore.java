...
public class FakeStore {
    ...
    private List<Option> optionDummyList(List<Product> productList) {
        return Arrays.asList(
                ...
                newOption(productList.get(3), 15,"선택01_바른곡물효소 누룽지맛 2박스", 17900),
                ...
                newOption(productList.get(6), 25,"이너딜리티 1박스", 26800),
                ...
                newOption(productList.get(9),30, "홍가리비2kg(50미이내)", 8900),
                ...
                newOption(productList.get(13),45, "[특품] 샤인머스켓 1kg 1-2수", 12900),
