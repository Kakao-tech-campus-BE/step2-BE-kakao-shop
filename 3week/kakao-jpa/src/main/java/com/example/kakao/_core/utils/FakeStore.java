...
public class FakeStore {
    ...
    private List<ProductOption> productOptionList = optionDummyList(productList);
    private List<Cart> cartList = cartDummyList(productOptionList);
    private List<Order> orderList = orderDummyList();
    private List<OrderItem> orderItemList = itemDummyList(cartList);
    ...
    private ProductOption newOption(Product product, Integer id, String optionName, int price) {
    ...
    private Cart newCart(ProductOption productOption, Integer id, Integer quantity){
        return Cart.builder()
                .id(id)
                .user(newUser(1, "ssar"))
    ...
    private OrderItem newItem(Cart cart, Integer id){
    ...
    private List<OrderItem> itemDummyList(List<Cart> cartList){
    ...
    private List<Cart> cartDummyList(List<ProductOption> productOptionList){
        return Arrays.asList(
             newCart(productOptionList.get(0), 1, 5),
             newCart(productOptionList.get(1), 2, 5)
        );
    }
    ...
    private List<ProductOption> optionDummyList(List<Product> productList) {
        return Arrays.asList(
