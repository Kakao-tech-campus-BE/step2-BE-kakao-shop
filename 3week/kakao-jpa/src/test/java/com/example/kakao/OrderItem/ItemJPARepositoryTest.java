...
public class ItemJPARepositoryTest extends DummyEntity {
    ...
    public void item_findById_test(){
        ...
        Assertions.assertThat(findItem.getOrder().getUser().getUsername()).isEqualTo("권해");
    ...
    public void item_findByOrderId_Test(){
        ...
        Assertions.assertThat(findItems.get(0).getOrder().getUser().getUsername()).isEqualTo("권해");
