...
public class DummyEntity {
    ...
    protected List<Item> itemDummyList(){
        newOption(newProduct("짱맛", 1, 24000), "옵션1", 2000);
        return Arrays.asList(
                newItem(newCart(newUser("kevin"), newOption(newProduct("짱맛", 1, 24000), "옵션1", 2000), 2), newOrder(newUser("kevin"))),
                newItem(newCart(newUser("doll"), newOption(newProduct("짱맛", 1, 24000), "옵션1", 2000), 2), newOrder(newUser("doll"))),
                newItem(newCart(newUser("yahoo"), newOption(newProduct("짱맛", 1, 24000), "옵션1", 2000), 2), newOrder(newUser("yahoo")))
                );
    }
