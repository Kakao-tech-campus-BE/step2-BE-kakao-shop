...
public class ProductJPARepositoryTest extends DummyEntity {
    ...
    @DisplayName("상품ID로 옵션리스트 조회 테스트 - Eager")
    @Test
    public void option_findByProductId_eager_test() throws JsonProcessingException, Exception {
        // given
        int id = 1;
    ...
    @DisplayName("상품ID로 옵션리스트 에러 테스트 - Lazy")
    @Test
    ...
    // 추천
    // 조인쿼리 직접 만들어서 사용하기
    @DisplayName("조인쿼리를 사용한 상품ID로 옵션리스트 조회 테스트 - Lazy")
    @Test
