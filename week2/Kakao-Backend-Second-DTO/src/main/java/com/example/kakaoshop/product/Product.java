...
public class Product extends BaseEntity {
    ...
    // 이미지는 null이어도 된다고 판단 사실 Empty("")로 해도된다고 생각한다. null은 정규화 관점에서 독이기 때문
    @Column(length = 500)
    ...
    // DTO에서 null, 양수등의 검증을 할 예정이므로 엔티티에선 필요없다고 판단된다.
    @Builder
    ...
    // 더 나은 방법을 찾고싶어 디자인 패턴을 조사하는 중 이는 POJO 철학에 위배할 거 같아 해당 방법으로만 작성합니다.
