...
public class CartRestController {
    ...
    public ResponseEntity<?> addCart(@RequestBody List<AddCartDTO> addCartDTOList){
        List<CartDTO> AddcartDTOList = new ArrayList<>();
        return ResponseEntity.ok("success : true");
    }

    @PostMapping("/carts/update")
    public ResponseEntity<?> updateCart(@RequestBody List<UpdateCartDTO> updateCartDTOList){
        ...
        CartRespUpdateDTO respDTO = new CartRespUpdateDTO(cartDTOList, 209000);
