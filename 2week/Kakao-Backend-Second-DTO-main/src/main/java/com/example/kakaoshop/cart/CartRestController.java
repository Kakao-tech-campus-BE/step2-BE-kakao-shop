...
import com.example.kakaoshop._core.security.SecurityUtil;
import com.example.kakaoshop._core.utils.ApiUtils;
import com.example.kakaoshop.cart.request.CartReqDTO;
...
public class CartRestController {
    ...
    public ResponseEntity<?> addCarts(@RequestBody List<CartReqDTO> cartReqDTOList) {
        return ResponseEntity.ok(new ResponseDTO(true, null, null));
    }

    @PutMapping("/carts/update")
    public ResponseEntity<?> updateCarts(@RequestBody List<CartReqDTO> cartReqDTOList) {
        // 카트 아이템 리스트 만들기
        List<CartItemDTO> cartItemDTOList = new ArrayList<>();
